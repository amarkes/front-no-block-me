...
export const TransactionsProvider = ({ children }) => {
  ...
  const loadInitialData = useCallback(async () => {
    if (dataLoaded) return; // Evita recarregar se já foi carregado
    
    try {
      setLoading(true);
      
      // Carrega transações, categorias e resumo em paralelo
  ...
  // Refresh data (força recarregamento)
